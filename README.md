...
> ImproperlyConfigured("You're using the staticfiles appdjango.core.exceptions.ImproperlyConfigured: You're using the 
> staticfiles app without having set the STATIC_ROOT setting to a 
> filesystem path.

       
DISABLE_COLLECTSTATIC=1 added to the Heroku config variable settings
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzU1MTkxMTAsMTI3OTU5ODAwNiwzOT
